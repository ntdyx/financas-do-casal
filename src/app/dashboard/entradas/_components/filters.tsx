...
export function EntradasFilters({ accounts, currentMes, currentQ, currentConta, currentContaTipo }: Props) {
  ...
  const hasActiveFilters = !!(currentConta || currentContaTipo || currentQ)
  ...
  return (
    <div className="mb-6 flex flex-wrap items-center gap-2">
      ...
      <SearchBox current={currentQ} onSearch={(v) => push('q', v)} placeholder="Buscar entrada…" />
